...
ifelse(!dir.exists(file.path("Models", "Seasonal_Models_Ellenbergs_Plots")), dir.create(file.path("Models", "Seasonal_Models_Ellenbergs_Plots")), FALSE)


for (i in seq_along(model_list)) {
  plotdirectory <-
    file.path("Models", "Seasonal_Models_Ellenbergs_Plots", names(model_list)[[i]])
...
comparisondir <- file.path("Models", "Seasonal_Models_Ellenbergs_Plots")
