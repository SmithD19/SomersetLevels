...
ifelse(!dir.exists(file.path("Models", "SpikeSlab_Plots")), dir.create(file.path("Models", "SpikeSlab_Plots")), FALSE)


for (i in seq_along(model_list)) {
  plotdirectory <-
    file.path("Models", "SpikeSlab_Plots", names(model_list)[[i]])
...
comparisondir <- file.path("Models", "SpikeSlab_Plots")
