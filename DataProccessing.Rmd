...
How often is each plant actually recorded in a plot?
```{r}
# So how many samples dow e have?
...
Location and Study Design Vars
```{r}
dfstudy <- clean %>% 
  select(study) %>%
...
Bind together and aggregate dip_point out of the frame
```{r}
